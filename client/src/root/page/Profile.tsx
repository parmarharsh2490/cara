...
const Profile: React.FC = () => {
  ...
  return (
    <>
      <Meta
      title="Profile - Sara-Ecommerce"
      description="View and update your profile information on Sara-Ecommerce. Manage your personal details, contact information, and other settings to keep your profile up-to-date."
      keywords="Profile, Sara-Ecommerce, Personal Information, Contact Details, Profile Management"
      />
